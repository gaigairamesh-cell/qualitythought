                                  ...
                                  >
                                    <div className="space-y-1.5">
                                      <div className="flex items-start justify-between gap-1.5">
                                        <span className="bg-indigo-50 border border-indigo-150 text-indigo-700 font-mono text-[8px] font-black py-0.5 px-1.5 rounded uppercase shrink-0">
                                          {isYoutube ? "YOUTUBE GUIDE" : "EXTERNAL RESOURCE"}
                                        </span>
